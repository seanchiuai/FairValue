...
- **Room reputation and calibration** — Settled rooms produce a `room-reputation/v1` summary from public bet history, public reason counts, final outcome accuracy, and Brier-style calibration. It is replayed from settlement events and deliberately excludes session IDs, host/user tokens, and private evidence.
