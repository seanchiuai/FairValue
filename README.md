...
- `/ops/incidents` is the frontend operator console over those endpoints. It stores an optional ops token in session storage, clears raw notes after PATCH, and relies on the server-side workflow redactor for persisted timeline notes.
