...
function publicActivityProjection(activity) {
  return (activity || []).map((entry) => ({
    ...
    future_median_price: typeof entry.future_median_price === 'number' ? entry.future_median_price : null,
    price_momentum_threshold: typeof entry.price_momentum_threshold === 'number' ? entry.price_momentum_threshold : null,
...
function publicSettlementProjection(settlement) {
  ...
  return {
    ...
    baseline_median_price: Number.isFinite(settlement.baseline_median_price) ? settlement.baseline_median_price : null,
    price_momentum_threshold: Number.isFinite(settlement.price_momentum_threshold) ? settlement.price_momentum_threshold : null,
    price_momentum_return: Number.isFinite(settlement.price_momentum_return) ? settlement.price_momentum_return : null,
